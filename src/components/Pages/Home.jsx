...
import { Link } from 'react-router-dom'; // Para o botão de Contato
import profileImage from '../../assets/navbar/profile.jpg'; // Reutilizando a imagem da navbar

// Um componente simples para o ícone de download. 
// Você pode usar uma biblioteca de ícones como react-icons se preferir.
const DownloadIcon = () => (
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              href="public\documents\CURRICULO Ux - GIULLIA BEATRIZ RAMOS E SILVA .pdf" // Lembre-se de colocar seu CV na pasta 'public' e linkar aqui
              download
            ...
            {/* Botão de Contato (estilo contorno) */}
            <Link 
              to="/contato"
